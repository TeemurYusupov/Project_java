...
public class Toy_Lottery {
    private List<project_java.Toy> listToys = new ArrayList<>();
    private int toy_count;

    public List<project_java.Toy> getToys() {
        return listToys;
    }
    ...
    public List<project_java.Toy> add_toy_in_listToy(project_java.Toy name) {
        listToys.add(name);
        toy_count++;
        return listToys;
    }
    ...
    private List<project_java.Toy> delete_toy_in_listToy(project_java.Toy name) {
